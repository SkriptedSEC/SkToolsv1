...
#Saludos A Todo El Team De Skripted Y A H4ckSec
...
def uno():
    ...
    cmd1 = os.system("apt-get autoclean && apt-get autoremove && apt-get purge")
    logo()
    todo()
def dos():
...
def tres():
    ...
    print "Actualizando ;)"
    cmd1 = os.system("apt-get dist-upgrade")
    logo()
    todo()
def cuatro():
    logo()
...
5.- Añadir Repositorios 6.- Remover Repositorios
...
\033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m			 
        ...
        \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m                 
                    ...
                    if hackingop2 == "1":
                        ...
                        md = os.system("echo 'download page : http://www.cqure.net/wp/tools/database/dbpwaudit/'")
                        tools2()
                    elif hackingop2 == "10":
        ...
        \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
                    ...
                    if hackingop4 == "1":
                        ...
                        cmd = os.system("apt-get install -y bbqsql hexorbase jsql sqlmap sqlninja sqlsus")
                        mistools()
                    else:
                        print "\033[1;91mPor Favor Teclee Unicamente El Numero De La Herramienta\033[1;m"
                        mistools()
        ...
        \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
                    ...
                    if hackingop11 == "1":
                        ...
                        cmd = os.system("apt-get install -y binwalk bulk-extractor chntpw cuckoo dc3dd ddrescue regripper dumpzilla extundelete foremost galleta guymager iphone-backup-analyzer p0f pdf-parser pdfid pdgmail peepdf volatility xplico")
                        mistools()
                    else:
                        print "\033[1;91mPor Favor Teclee Unicamente El Numero De La Herramienta\033[1;m"
                        mistools()
        ...
        \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
                    ...
                    if hackingop14 == "1":
                        cmd = os.system("apt-get install geany geany-plugins")
                        tools14()
                    elif hackingop14 == "back":
                        mistools()
                    elif hackingop14 == "2":
                        cmd = os.system("apt-get install eclipse")
                        tools14()
                    elif hackingop14 == "3":
                        cmd = os.system("apt-get install lazarus")
                        tools14()
                    elif hackingop14 == "4":
                        cmd = os.system("apt-get install netbeans")
                        tools14()
                    elif hackingop14 == "5":
                        cmd = os.system("apt-get install qtcreator")
                        tools14()
                    elif hackingop14 == "6":
                        cmd == os.system("apt-get install gnustep")
                        tools14()
                    elif hackingop14 == "7":
                        cmd = os.system("apt-get install emacs")
                        tools14()
                    elif hackingop14 == "8":
                        cmd == os.system("apt-get install kate")
                        tools14()
                    elif hackingop14 == "9":
                        cmd = os.system("apt-get install kdevelop")
                        tools14()
                    elif hackingop14 == "10":
                        cmd = os.system("apt-get install glade")
                        tools14()
                    elif hackingop14 == "11":
                        cmd = os.system("apt-get install anjuta")
                        tools14()
                    elif hackingop14 == "12":
                        cmd = os.system("apt-get install bluefish")
                        tools14()
                    elif hackingop14 == "13":
                        cmd = os.system("apt-get install codeblocks")
                        tools14()
                    elif hackingop14 == "0":
                        cmd = os.system("apt-get -y install geany geany-plugins eclipse lazarus netbeans qtcreator gnustep emacs kate kdevelop glade anjuta bluefish codeblocks")
                        mistools()
                    else:
                        print "\033[1;91mPor Favor Teclee Unicamente El Numero De La Herramienta\033[1;m"
                        mistools() 
    ...
    \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
                    ...
                    if hackingop15 == "1":
                        cmd = os.system("apt-get install hexchat")
                        tools15()
                    elif hackingop15 == "back":
                        mistools()
                    elif hackingop15 == "2":
                        cmd = os.system("apt-get install privoxy")
                        tools15()
                    elif hackingop15 == "3":
                        cmd = os.system("apt-get install polipo")
                        tools15()
                    elif hackingop15 == "4":
                        cmd = os.system("apt-get install vidalia")
                        tools15()
                    elif hackingop15 == "5":
                        cmd = os.system("apt-get install torchat")
                        tools15()
                    elif hackingop15 == "6":
                        cmd = os.system("apt-get install proxychains")
                        tools15()
                    elif hackingop15 == "7":
                        cmd = os.system("git clone https://github.com/Und3rf10w/kali-anonsurf && cd kali-anonsurf/ && ./installer.sh && cd .. && rm -r kali-anonsurf")
                        tools15()
                    elif hackingop15 == "0":
                        cmd = os.system("apt-get -y install hexchat privoxy polipo vidalia torchat proxychains") 
                        mistools()
                    else:
                        print "\033[1;91mPor Favor Teclee Unicamente El Numero De La Herramienta\033[1;m"
                        mistools()
    ...
    \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
                    ...
                    if hackingop16 == "1":
                        cmd = os.system("apt-get install truecrypt")
                        tools16()
                    elif hackingop16 == "back":
                        mistools()
                    elif hackingop16 == "2":
                        cmd = os.system("apt-get install gnupg")
                        tools16()
                    elif hackingop16 == "3":
                        cmd = os.system("apt-get install encfs")
                        tools16()
                    elif hackingop16 == "0":
                        cmd = os.system("apt-get -y install truecrypt gnupg encfs")
                        mistools()
                    else:
                        print "\033[1;91mPor Favor Teclee Unicamente El Numero De La Herramienta\033[1;m"
                        mistools()
    ...
    \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
                    ...
                    if hackingop17 == "1":
                        cmd = os.system("apt-get install chkrootkit")
                        tools17()
                    elif hackingop17 == "back":
                        mistools()
                    elif hackingop17 == "2":
                        cmd = os.system("apt-get install rkhunter")
                        tools17()
                    elif hackingop17 == "3":
                        cmd = os.system("apt-get install lynis")
                        tools17()
                    elif hackingop17 == "4":
                        cmd = os.system("apt-get install debsums")
                        tools17()
                    elif hackingop17 == "5":
                        cmd = os.system("git clone https://github.com/rfxn/linux-malware-detect && cd linux-malware-detect-master && ./install.sh && cd .. && rm -r linux-malware-detect-master")
                        tools17()
                    elif hackingop17 == "0":
                        cmd = os.system("apt-get -y install chkrootkit rkhunter lynis debsums")
                        mistools()
                    else:
                        print "\033[1;91mPor Favor Teclee Unicamente El Numero De La Herramienta\033[1;m"
                        mistools()
    ...
    \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
            ...
            if Accesorios == "1":
                cmd = os.system("apt-get install -y virtualbox-guest-x11 virtualbox virtualbox-ext-pack linux-headers* && usermod -a -G vboxusers ddos")
                Acees()
            elif Accesorios == "2":
                cmd = os.system("apt-get -y install bleachbit")
                Acees()
            elif Accesorios == "3":
                ...
                if arquitectura == "32":
                    cmd = os.system("wget https://archive.org/download/google-chrome-stable_48.0.2564.116-1_i386/google-chrome-stable_48.0.2564.116-1_i386.deb && dpkg -i google-chrome-stable_48.0.2564.116-1_i386.deb && rm google-chrome-stable_48.0.2564.116-1_i386.deb")
                    ...
                    cmd = os.system("wget https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb && dpkg -i google-chrome-stable_current_amd64.deb && rm google-chrome-stable_current_amd64.deb")
                    cmd1 = os.system("apt-get -f install")
                    print "\033[1;91mLa Instalacion Se Completo Con Exito, Para Ejecutar \nGoogle Chrome Por Favor Escriba El Comando\n\n /usr/bin/google-chrome-stable --no-sandbox --user-data-dir\033[1;m"
                    Acees()
                else:
                ...
                cmd = os.system('echo "deb http://ppa.launchpad.net/webupd8team/java/ubuntu trusty main" | tee /etc/apt/sources.list.d/webupd8team-java.list && echo "deb-src http://ppa.launchpad.net/webupd8team/java/ubuntu trusty main" | tee -a /etc/apt/sources.list.d/webupd8team-java.list')
                cmd1 = os.system("apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys EEA14886")
                cmd2 = os.system("apt-get update")
                cmd3 = os.system("apt-get -y install oracle-java8-installer")
                Acees()
            elif Accesorios == "5":
                cmd = os.system("apt-get -y install pinta")
                Acees()
            elif Accesorios == "6":
                cmd = os.system("apt-get -y install gtk-recordmydesktop")
                Acees()
            elif Accesorios == "7":
                cmd = os.system("apt-get -y remove iceweasel")
                cmd1 = os.system("echo -e deb http://downloads.sourceforge.net/project/ubuntuzilla/mozilla/apt all main | tee -a /etc/apt/sources.list > /dev/null")
                cmd2 = os.system("apt-key adv –recv-keys –keyserver keyserver.ubuntu.com C1289A29")
                cmd3 = os.system("apt-get update")
                cmd4 = os.system("apt-get --force-yes install firefox-mozilla-build")
                Acees()
            elif Accesorios == "8":
                cmd = os.system("apt-get -y install flashplugin-nonfree")
                cmd1 = os.system("update-flashplugin-nonfree --install")
                Acees()
            elif Accesorios == "9":
                cmd = os.system("apt-get install kali-menu")
                Acees()
            elif Accesorios == "10":
                cmd = os.system("apt-get install shutter")
                Acees()
            elif Accesorios == "11":
                cmd = os.system("apt-get install gparted")
                Acees()
            elif Accesorios == "12":
                cmd = os.system("apt-get install okular")
                Acees()
            elif Accesorios == "13":
                cmd = os.system("apt-get install clementine")
                Acees()
        ...
        cmd = os.system("service --status-all")
    elif cuatroop == "4":
        def acces():
            logo()
            print '''
    \033[1;91m#########################################\033[1;m
        ...
        \033[1;91mO Puedes Escribir 'back' Sin Comillas Para Regresar Al Menu Anterior :D\033[1;m
            ...
            if Entornos == "1":
                ...
                cmd = os.system("apt --fix-broken install && apt-get install lxde-core lxde desktop-base")
                acces()
            elif Entornos == "3":
                cmd = os.system("apt-get install desktop-base xfce4 xfce4-places-plugin xfce4-goodies")
                acces()
            elif Entornos == "4":
                cmd = os.system("apt-get install gnome-core desktop-base")
                acces()
            elif Entornos == "5":
                cmd = os.system("apt-get install desktop-base cinnamon")
                acces()
            elif Entornos == "6":
                cmd = os.system("apt-get install desktop-base kde-plasma-desktop")
                acces()
            elif Entornos == "0":
                cmd = os.system("apt --fix-broken install && apt-get install lxde-core lxde desktop-base desktop-base xfce4 xfce4-places-plugin xfce4-goodies gnome-core desktop-base desktop-base cinnamon desktop-base kde-plasma-desktop")
                mistools()
        acces()         
    elif cuatroop == "5":
        cmd2 = os.system("echo '# skriptedSEC\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> /etc/apt/sources.list")
        cmd3 = os.system("echo '# skriptedSEC\ndeb http://old.kali.org/kali sana main non-free contrib' >> /etc/apt/sources.list")
        cmd4 = os.system("echo '# skriptedSEC\ndeb http://old.kali.org/kali moto main non-free contrib' >> /etc/apt/sources.list")
    elif cuatroop == "6":
